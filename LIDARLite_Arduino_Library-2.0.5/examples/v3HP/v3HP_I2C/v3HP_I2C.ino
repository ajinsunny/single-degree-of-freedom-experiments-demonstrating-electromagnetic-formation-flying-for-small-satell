...
void setup()
{
  ...
  myFile = SD.open("data.csv", FILE_WRITE);
    ...
    #ifdef FAST_I2C
        #if ARDUINO >= 157
            Wire.setClock(100UL); // Set I2C frequency to 400kHz (for Arduino Due)
        #else
            TWBR = ((F_CPU / 100UL) - 16) / 2; // Set I2C frequency to 400kHz
        #endif
    #endif
...
void loop()
{
    ...
    do
    {
       ...
       //Write the new distance data to file
